...
export const QuestionCard: React.FC<QuestionCardProps> = ({ title, num, text, path, buttonValue, buttonImage, buttonPath }) => {
  return (
    <article className="bg-[#f3f5f8] rounded-[30px] flex justify-between items-center px-[20px] py-[17px] lg:px-[30px] lg:py-[20px] xl:py-[22px] xl:pb-[19px]">
      <div>
        <div className="flex">
          <span className="font-medium ml-2 text-[16px] lg:mt-[4px] xl:mt-0 lg:text-2xl">{num}.</span>
          <p className="font-medium ml-2 text-[16px] lg:mt-[4px] leading-[21px] md:leading-normal xl:mt-0 lg:text-2xl">{title}</p>
        </div>
